{
  # This example flake.nix from the dream2nix repository is pretty generic and the same for all
  # examples, except when they define devShells or extra packages.

  # To initialize the project after cloning this repository, run:
  #   nix run '.#default.lock'
  # To enter a development shell, run:
  #   nix develop

  description = "Flake for palindromi.fi development";
