# A Python package with dependencies defined via pyproject.toml
{
  config,
  lib,
  dream2nix,
...
in {
  ...
  pip = {
    ...
    #   editables.my-internal-dependency = "/home/my-user/src/my-internal-dependency";
    #editables.my-internal-dependency = ".editables/my-internal-dependency";
